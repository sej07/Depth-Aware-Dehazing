...
from src.models import DepthGuidedFFANet
...
def main(args):
    ...
    # Model
    print("Creating DepthGuidedFFANet")
    model = DepthGuidedFFANet(
        in_channels=3,
        channels=args.channels,
        num_groups=args.num_groups,
        num_blocks=args.num_blocks,
        attention_type=args.attention_type,
        injection_points=[args.injection]
    )
    print(f"  Parameters: {model.get_num_params():,}")
    print(f"  Attention type: {args.attention_type}")
    print(f"  Injection point: {args.injection}")
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Train Depth-Guided Attention Model')
    
    parser.add_argument('--image_size', type=int, default=256)
    parser.add_argument('--channels', type=int, default=64)
    parser.add_argument('--num_groups', type=int, default=3)
    parser.add_argument('--num_blocks', type=int, default=6)
    parser.add_argument('--attention_type', type=str, default='learned', choices=['direct', 'learned'])
    parser.add_argument('--injection', type=str, default='middle', choices=['early', 'middle', 'late'])
    ...
    parser.add_argument('--experiment_dir', type=str,
                        default='/home/barshikar.s/depth-aware-dehazing/experiments/depth_attention')
